...
The ICEBED tool includes the GlabTop2_IITBversion ice thickness modelling approach (refer to Ramsankaran et al., 2018), an improved version of the GlabTop2 model developed by Frey et al., (2014). ICEBED adopts a semi-automated approach to estimate glacier specific shape factor based ice thickness for glaciers lacking field measurements using the approach given in Ramsankaran et al (2018). ICEBED is coded in MATLAB.
